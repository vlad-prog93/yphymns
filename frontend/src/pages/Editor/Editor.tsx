...
const Editor = () => {
  ...
  return (
    <>
      ...
      <div className={style.editor__buttonContainer}>
          ...
          <Details key={collection._id}>
            ...
            <ul className={style.editor__list}>
              {hymnsInCollection.map(h => (
                <li key={h._id} className={style.editor__item}>
                  <span className={style.editor__itemNumber}>{h.number}</span>
                  <span className={style.editor__itemTitle}>{h.title}</span>
